...
const ExerciseList = ({ addExercise }: ExercisePropsForLocal) => {
  ...
  return (
    <div className="flex gap-5 flex-col sticky top-0 border-[#ECEDF0] dark:border-black border border-solid bg-white dark:bg-[#2B2C32] h-full min-w-[330px] rounded-md divide-y">
