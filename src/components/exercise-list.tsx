...
const ExerciseList = ({ addExercise }: ExercisePropsForLocal) => {
  ...
  return (
    <div className="hidden lg:flex gap-5 flex-col sticky top-0 border-[#ECEDF0] dark:border-black border border-solid bg-white dark:bg-[#2B2C32] min-w-[300px] rounded-md divide-y max-h-[85vh]">
      <div className="px-4 pt-4">
        <h1 className="font-medium text-base text-left ">My Exercises</h1>
      </div>
