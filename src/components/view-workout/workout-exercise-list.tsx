...
const WorkoutExerciseList = (workout_id: WorkoutProps, {workout_name}: WorkoutProps) => {
  ...
  return (
    <div className="flex gap-5 flex-col border-[#ECEDF0] dark:border-black border border-solid bg-white dark:bg-[#2B2C32] h-full w-11/12 lg:w-full rounded-md p-10">
      <div>
